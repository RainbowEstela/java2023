...
public class Enemigo {
	 ...
	 * @param weaponDamage
	 */
	public Enemigo(String nombre, String clase, int weaponDamage) {
		super();
		this.nombre = nombre;
		this.clase = clase;
		this.nivel = 1;
	...
	/**
	 * metodo que hiere a la entidad la cantidad del daño de arma
	 * @param ene
	 */
	public void golpear(Jugador ene) {
		
		ene.recivirDamage(this.weaponDamage);
	}
	
	/**
	 * funcion que recive el daño a la vida
	 * @param damage
	 */
